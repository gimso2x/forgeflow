.PHONY: validate demo validate-demo validate-json validate-no-python validate-skills validate-agent-docs validate-templates validate-template-refs validate-versions validate-changelog-links validate-gemini-imports validate-plugin-prompts validate-evals-json validate-eval-files validate-workflow-vocab validate-finish-safety validate-adapter-config validate-markdown-links
...
validate: validate-no-python validate-json validate-versions validate-changelog-links validate-skills validate-agent-docs validate-templates validate-template-refs validate-demo validate-gemini-imports validate-plugin-prompts validate-evals-json validate-eval-files validate-workflow-vocab validate-finish-safety validate-adapter-config validate-markdown-links
