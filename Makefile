.PHONY: validate validate-json validate-no-python validate-skills validate-templates validate-versions validate-gemini-imports validate-markdown-links
...
validate: validate-no-python validate-json validate-versions validate-skills validate-templates validate-gemini-imports validate-markdown-links
