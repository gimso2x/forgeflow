.PHONY: validate validate-json validate-no-python validate-skills validate-templates validate-versions validate-changelog-links validate-gemini-imports validate-evals-json validate-workflow-vocab validate-markdown-links
...
validate: validate-no-python validate-json validate-versions validate-changelog-links validate-skills validate-templates validate-gemini-imports validate-evals-json validate-workflow-vocab validate-markdown-links
