...
GENERATED = {
    ...
    "gemini": ROOT / "adapters/generated/gemini/GEMINI.md",
}
MANIFESTS = {
    ...
    "gemini": ROOT / "adapters/targets/gemini/manifest.yaml",
}
DELIVERY_NOTES = {
    ...
    "gemini": "Gemini delivers recovery through GEMINI.md instruction guidance, not hooks.",
}
