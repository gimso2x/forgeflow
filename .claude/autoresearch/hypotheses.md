...
- [AUTO-005] Look for duplicated test fixture/assertion scaffolding in recent ForgeFlow tests and centralize only if it removes real drift risk without hiding intent.
