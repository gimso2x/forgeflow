...
## Pending
- [AUTO-011] Inspect standalone Makefile helper target documentation for setup/check-env prerequisites and add one narrow doc/test alignment only if direct helper usage can still drift.
