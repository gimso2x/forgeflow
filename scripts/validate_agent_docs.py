...
checks = [
    ('skills/_shared/discipline.md', '.gemini/extensions', 'shared discipline must protect Gemini extension cache paths'),
    ('skills/clarify/SKILL.md', '.gemini/extensions', 'clarify must protect Gemini extension cache paths'),
