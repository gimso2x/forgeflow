...
checks = {
    ...
    'skills/review/references/role-checklists.md': ['Checklist version:', 'role input packet', 'Role trigger matrix', 'role evidence map', 'scoped files/ranges/exclusions', 'constraints/focus flags', 'criteria basis', 'Role criteria are not interchangeable', 'Evidence Escalation Log', 'blocked: missing role input packet'],
