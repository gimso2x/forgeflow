...
if not (trigger_matrix_pos != -1 and role_evidence_map_pos != -1 and role_packet_readiness_pos != -1 and role_packets_pos != -1 and role_capability_hints_pos != -1 and ownership_plan_pos != -1 and normalization_gate_pos != -1 and adapter_handoff_pos != -1 and trigger_matrix_pos < role_evidence_map_pos < role_packet_readiness_pos < role_packets_pos < role_capability_hints_pos < ownership_plan_pos < normalization_gate_pos < adapter_handoff_pos):
    failures.append('templates/normalized-input.md: role trigger matrix must appear before role evidence map, role input packet readiness, role input packets, role capability hints, review ownership plan, normalization gate, and adapter handoff checklist')
