...
ownership_required_fragments = ['exactly one lead', 'exactly one identifier', 'aggregation_owner', 'conflict_policy', 'Human Review Gate', 'does not silently choose a winner']
