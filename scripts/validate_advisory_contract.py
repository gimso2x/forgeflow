...
classification_fields = ['Source Classification Rationale', 'Why this type', 'Ambiguities considered', 'Ambiguity outcome', 'Evidence Source Map', 'type=diff|file|artifact|url|command_output|reported_summary|missing', 'status=success|partial|failed|not_applicable', 'fetched_at=<ISO8601 timestamp|run label|not_applicable>', 'freshness_status=current|stale|unknown', 'evidence_level=observed|reported|missing', 'Access Posture', 'read_only | verification_only | not_applicable', 'Mutation Check']
