...
checks = {
    ...
    'README.md': ['docs/review-runtime-contract.md', 'adapter-neutral input normalization', 'input-source.md', 'normalized-input.md', 'source classification rationale', 'role trigger matrix', 'adapter별 별도 report나 자동 승인 경로 없음', '.diff`/`.patch` 파일'],
}
failures = []
