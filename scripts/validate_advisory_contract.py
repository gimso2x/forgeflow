...
integrity_required_fragments = ['id_resolution', 'source_map_match', 'scope_map_coverage', 'role_map_coverage', 'packet_reference_freshness', 'blocking_notes', 'Evidence Source Map']
