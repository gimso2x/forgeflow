...
checks = {
    ...
    'templates/review-report.md': ['Evidence Source', 'Evidence Level', 'Evidence Quote', 'Severity escalation rule', 'blockers=N', 'observed | reported | missing', 'Checklist Version', 'role-pass record', 'Chat-only completion claims are not evidence', 'Normalization Gate', 'Fetched At', 'Freshness Status', 'Access Posture', 'Mutation Check', 'Fetch Method Ledger', 'Evidence Source Map', 'Adapter Handoff Checklist', 'fetch_ledger_complete', 'canonical_review_ownership', 'Role routing rationale', 'Role evidence map', 'Evidence freshness', 'Evidence Freshness', 'Role criteria basis summary', 'Criteria Basis Used', 'Evidence gap register', 'Review ownership plan', 'exactly one lead reviewer', 'Conflict policy', 'Human Review Gate', 'Active roles', 'Skipped roles', 'Trigger Rationale', 'Claim Marker', 'Independence Check', 'Evidence Escalation Log', 'Requester Role', 'Approval Impact', 'packet_freshness'],
