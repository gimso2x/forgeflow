...
description: Implements scoped Next.js changes for Gemini within ForgeFlow boundaries.
---

# ForgeFlow Next.js Worker for Gemini
...
- Do not create global Gemini configuration for project setup.
