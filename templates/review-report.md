...
## Plan Task 준수 (Plan Task Conformance)
<!-- Pipeline mode only. Standalone mode: delete this section. -->
<!-- Plan-vs-reality check: every plan task traced to execution evidence. -->
<!-- Small route: primary task + listed files only. Medium+: full traceability. -->
<!-- Generated by Step 3c (Plan Conformance Gate) in ff-review procedure. -->

- **Conformance verdict**: <!-- PASS | PARTIAL | FAIL -->
- **Tasks traced**: <!-- N/M plan tasks verified -->
- **Coverage summary**: <!-- one-line: "all tasks implemented" or "T3 file missing, T5 verification skipped" -->

### Per-task trace
<!-- Repeat for each non-skip/non-deferred plan task -->

- **Task**: <!-- plan task ID + title -->
  - **Status in ledger**: <!-- done | running | pending | missing -->
  - **Files planned → actual**: <!-- planned: [list] → actual: [list] | all present | MISSING: [files] -->
  - **Verification planned → run**: <!-- planned gate → observed result | NOT RUN -->
  - **Fulfills → criterion addressed**: <!-- fulfills target → evidence of completion | UNFULFILLED -->
  - **Conformance**: <!-- PASS | FAIL — <reason> -->
