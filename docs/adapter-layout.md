...
5. Do not move `.agents/plugins/marketplace.json`, `plugins/forgeflow`, `.codex-plugin/plugin.json`, `.claude-plugin/*`, `.cursor-plugin/plugin.json`, or `gemini-extension.json` without an accompanying install/build target and README update.
