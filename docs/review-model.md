...
- task-specific Review Criteria: acceptance traces, applicable conventions, relevant ADRs/decisions, active rules, and risk checks
...
- p1/p2 finding을 수정하지 않고 `rejected` 또는 `risk_accepted`로 처리하려는 경우
