...
| Cursor | Skill names without colons. Same adjustments as the underlying adapter (Claude by default). | IDE-native artifact writes; prefer file artifacts over chat-only summaries. | Same as underlying adapter. |
