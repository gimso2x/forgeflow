...
- Role-pass records for every active role, including zero-finding passes, with inspected scope/evidence, observed verification or no-command rationale, limitations, finding counts, and role verdict
