...
- Every task directory must carry project metadata in the active state artifact (`run-state.json` when present, otherwise checkpoint/frontmatter): `repo_root`, `project_name`, `project_slug`, and `task_id`.
