...
- Standalone Input Source (type, original input, fetch status, fetched_at/run label, freshness status, access posture, mutation check, Fetch Method Ledger references, Evidence Source Map references)
