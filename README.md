...
각 reviewer role은 같은 입력을 공유하더라도 독립적으로 근거를 남깁니다. Finding에는 role, checklist version, evidence source, evidence level(`observed | reported | missing`)을 포함하고, role별 evidence requirement는 [`skills/review/references/role-checklists.md`](skills/review/references/role-checklists.md)에 둡니다.
