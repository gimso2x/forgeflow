...
Current release: `1.11.6` (source of truth: [`VERSION`](VERSION)).
...
- `review-report.md`: standalone input source summary는 Fetch Method Ledger row와 Evidence Source Map references를 echo해, 독자가 report만 보고도 finding/role summary evidence가 어떤 multi-fetch provenance에 묶였는지 확인할 수 있어야 합니다.
