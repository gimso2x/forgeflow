...
- `scripts/forgeflow_evolution.py inspect` / `list` / `dry-run --rule <id>` / gated `execute --rule <id>` — evolution policy/runtime-safety summaries plus explicitly acknowledged project-local rule execution
